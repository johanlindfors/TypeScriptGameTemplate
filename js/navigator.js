(function () {
    ...
    WinJS.Namespace.define("GameManager", {
        PageControlNavigator: WinJS.Class.define(function (element, options) {
            ...
            _fwdbackHandler: function (e) {
                switch(e.keyCode) {
                    case e.altKey && utils.Key.leftArrow: {
                        nav.back();
                        break;

                    }
                    case e.altKey && utils.Key.rightArrow: {
                        nav.forward();
                        break;
            ...
            _navigated: function (e) {
                ...
                var that = this;
                WinJS.UI.Pages.render(e.detail.location, newElement, e.detail.state, parented).done(function (control) {
            ...
            _updateLayout: {
                get: function () {
                    return (this.pageControl && this.pageControl.updateLayout) || function () {
                    };
                }
            },
            navigated: function () {
